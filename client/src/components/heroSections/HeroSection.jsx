              ...
              <div className="card-1 w-full h-full rounded-md relative overflow-hidden cursor-pointer">
                ...
                <div className="content absolute bottom-0 left-0 p-4 text-white z-20">
                  <div className="flex space-x-2 mb-2">
                    <span className="bg-red-800 px-3.5 py-[0.3rem] rounded-md tracking-[0.2em] font-[0.6rem] text-xs uppercase leading-none">
                      Travel
                    </span>
                    <span className="bg-blue-800 px-3.5 py-[0.3rem] rounded-md tracking-[0.2em] font-[0.6rem] text-xs uppercase leading-none">
                      Food
                    </span>
                  </div>
                  <h2>
