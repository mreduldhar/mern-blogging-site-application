...
const RecentPost = () => {
  return (
    <div className="container mx-auto w-full h-full bg-[#F8F9FA]">
      <div className="px-20 pt-28 pb-20">
        <h1 className="text-5xl">Recent Posts</h1>
      </div>
      {/* first row */}
      <div className="row flex justify-between px-20 mb-10">
        <div className="card w-[32%] h-auto col-end-3">
          <a href="#">
          ...
          <div className="content p-7">
            ...
            <p className="text-[#666666] py-5 text-xl">
              ...
              facilis fugit recusandae! Illo, aliquid, dicta beatae quia porro
              id est.
            </p>
        ...
        <div className="card w-[32%] h-auto col-end-3">
          <a href="#" className="">
            <img className="rounded-lg object-cover" src={mountain} alt="" />
          </a>
          <div className="content p-7">
            <div className="categories text-white">
